...
public abstract class WorldGenTreeProvider {
    ...
    @Nullable
    protected abstract Holder<? extends WorldGenFeatureConfigured<?, ?>> getConfiguredFeature(Random random, boolean flag);
    ...
    public boolean growTree(WorldServer worldserver, ChunkGenerator chunkgenerator, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        Holder<? extends WorldGenFeatureConfigured<?, ?>> holder = this.getConfiguredFeature(random, this.hasFlowers(worldserver, blockposition));
