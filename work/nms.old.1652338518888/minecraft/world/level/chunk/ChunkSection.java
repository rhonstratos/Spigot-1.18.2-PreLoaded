...
public class ChunkSection {
    ...
    public ChunkSection(int i, DataPaletteBlock<IBlockData> datapaletteblock, DataPaletteBlock<Holder<BiomeBase>> datapaletteblock1) {
    ...
    public ChunkSection(int i, IRegistry<BiomeBase> iregistry) {
        ...
        this.biomes = new DataPaletteBlock<>(iregistry.asHolderIdMap(), iregistry.getHolderOrThrow(Biomes.PLAINS), DataPaletteBlock.e.SECTION_BIOMES);
    }
